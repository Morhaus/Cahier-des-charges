...
\begin{table}[]
\centering
\caption{First submission detailed work table}
\label{my-label}
\begin{tabular}{|lcccc|}
\hline
\multicolumn{1}{|c}{\textbf{First submission}}                                                                    & \multicolumn{1}{l}{\textit{\textbf{Tristan}}} & \multicolumn{1}{l}{\textit{\textbf{Simon}}} & \multicolumn{1}{l}{\textit{\textbf{Alexandre}}} & \multicolumn{1}{l|}{\textit{\textbf{Cyril}}} \\ \hline
\multicolumn{1}{|l|}{\textit{Basic LAN/WAN Multiplayer}}                                                          & \textbf{X}                                    & \textbf{X}                                  & \textbf{}                                       & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{Client-side collisions simulation}}                                                  & \textbf{}                                     & \textbf{}                                   & \textbf{X}                                      & \textbf{X}                                   \\ \hline
\multicolumn{1}{|l|}{\textit{Basic car physics simulation}}                                                       & \textbf{}                                     & \textbf{}                                   & \textbf{X}                                      & \textbf{X}                                   \\ \hline
\multicolumn{1}{|l|}{\textit{Basic ball physics simulation}}                                                      & \textbf{X}                                    & \textbf{}                                   & \textbf{X}                                      & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{\begin{tabular}[c]{@{}l@{}}Car wheel, wheel joints and\\ body physics\end{tabular}}} & \textbf{}                                     & \textbf{X}                                  & \textbf{}                                       & \textbf{X}                                   \\ \hline
...
\begin{table}[]
\centering
\caption{Second submission detailed work table}
\label{my-label}
\begin{tabular}{|lcccc|}
\hline
\multicolumn{1}{|c}{\textbf{First submission}}                                                                                                    & \multicolumn{1}{l}{\textit{\textbf{Tristan}}} & \multicolumn{1}{l}{\textit{\textbf{Simon}}} & \multicolumn{1}{l}{\textit{\textbf{Alexandre}}} & \multicolumn{1}{l|}{\textit{\textbf{Cyril}}} \\ \hline
\multicolumn{1}{|l|}{\textit{Game update system}}                                                                                                 & \textbf{X}                                    & \textbf{X}                                  & \textbf{}                                       & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{Server-side collisions simulation}}                                                                                  & \textbf{X}                                    & \textbf{}                                   & \textbf{X}                                      & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{\begin{tabular}[c]{@{}l@{}}Collisions simulation :\\ \\ - Car/Ball, Car/Field, Car/Car\\ - Ball/Field\end{tabular}}} & \textbf{}                                     & \textbf{}                                   & \textbf{X}                                      & \textbf{X}                                   \\ \hline
\multicolumn{1}{|l|}{\textit{Physics improvement}}                                                                                                & \textbf{}                                     & \textbf{}                                   & \textbf{X}                                      & \textbf{X}                                   \\ \hline
\multicolumn{1}{|l|}{\textit{Simple AI}}                                                                                                          & \textbf{}                                     & \textbf{X}                                   & \textbf{}                                       & \textbf{X}                                   \\ \hline
...
\hline
\multicolumn{1}{|c}{\textbf{First submission}}                                                                                                                & \multicolumn{1}{l}{\textit{\textbf{Tristan}}} & \multicolumn{1}{l}{\textit{\textbf{Simon}}} & \multicolumn{1}{l}{\textit{\textbf{Alexandre}}} & \multicolumn{1}{l|}{\textit{\textbf{Cyril}}} \\ \hline
\multicolumn{1}{|l|}{\textit{Friction simulation}}                                                                                                            & \textbf{}                                     & \textbf{}                                   & \textbf{X}                                      & \textbf{X}                                   \\ \hline
\multicolumn{1}{|l|}{\textit{Improved AI}}                                                                                                                    & \textbf{}                                     & \textbf{X}                                  & \textbf{}                                       & \textbf{X}                                   \\ \hline
\multicolumn{1}{|l|}{\textit{Physics tweaks}}                                                                                                                 & \textbf{}                                     & \textbf{}                                   & \textbf{X}                                      & \textbf{X}                                   \\ \hline
\multicolumn{1}{|l|}{\textit{Security for players' accounts}}                                                                                                 & \textbf{X}                                    & \textbf{X}                                  & \textbf{}                                       & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{Player statistics and schievements}}                                                                                             & \textbf{X}                                    & \textbf{}                                   & \textbf{}                                       & \textbf{X}                                   \\ \hline
\multicolumn{1}{|l|}{\textit{\begin{tabular}[c]{@{}l@{}}Server and client multiplayer\\ fuctionnalities' improvements\end{tabular}}}                          & \textbf{X}                                    & \textbf{}                                  & \textbf{X}                                       & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{Balancing gameplay}}                                                                                                             & \textbf{}                                     & \textbf{X}                                  & \textbf{X}                                      & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{\begin{tabular}[c]{@{}l@{}}In-game UI overhaul\\ \\ (Lobby, servers' list, rankings,\\ alternative game modes...)\end{tabular}}} & \textbf{X}                                    & \textbf{X}                                  & \textbf{}                                       & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{Public website rankings}}                                                                                                        & \textbf{X}                                    & \textbf{}                                   & \textbf{X}                                      & \textbf{}                                    \\ \hline
\multicolumn{1}{|l|}{\textit{Alternative game modes}}                                                                                                         & \textbf{}                                     & \textbf{X}                                  & \textbf{}                                       & \textbf{X}                                   \\ \hline
\end{tabular}
\end{table}
\end{landscape}
